...
<template>
  <div id="container">
        ...
        <template v-slot="{ size, dynamicColumns }">
          ...
          >
            <template #operation="{ row }">
              <div>
                <el-button type="primary" text @click="handleClickBtn(row)"
                  >变更教师负责人</el-button
                >
    ...
    <el-dialog
      ...
      destroy-on-close
    >
      <el-form :model="setTeacherManagerParams" ref="setFormRef" :rules="setManagerRules">
